...
// setPropertyIfNotNull(executionRequest.properties, message.vnfConfigurableProperties, 'sliceInstanceList1');
// setPropertyIfNotNull(executionRequest.properties, message.vnfConfigurableProperties, 'sliceInstanceList2');
// setPropertyIfNotNull(executionRequest.properties, message.vnfConfigurableProperties, 'sliceInstanceList3');
