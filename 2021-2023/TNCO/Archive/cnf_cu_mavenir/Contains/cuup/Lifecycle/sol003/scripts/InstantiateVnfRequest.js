...
// setPropertyIfNotNull(executionRequest.properties, message, 'instantiation_level');
 ...
 message.additionalParams.customValues= {
      ...
      message.additionalParams.customValues['cnfName']= executionRequest.properties.cuup_cnfname;
      message.additionalParams.customValues['profiles.mav_cuup_dev.charts[0].chart_key']= executionRequest.properties.cuup_chartkey;
