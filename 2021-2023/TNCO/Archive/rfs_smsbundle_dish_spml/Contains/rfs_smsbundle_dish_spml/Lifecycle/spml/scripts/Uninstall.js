...
array.forEach(function (item, index) {
    ...
    if(item.match(/^SMS$/)){
      ...
      message.modifications.push(
        ...
        {
            "path": executionRequest.properties.path14,
            "operation": executionRequest.properties.operation4
        },
        {
        ...
        {
            "path": executionRequest.properties.hss_path,
            "operation": executionRequest.properties.operation4
        },
        {
            "path": executionRequest.properties.hss_path2,
            "operation": executionRequest.properties.operation4
        },
        {
            "path": "udm5gData/servingPlmnId/provisionedData/smsSubscriptionData/smsSubscribed",
            "operation": executionRequest.properties.operation4
        },
        {
            "path": "udm5gData/servingPlmnId/provisionedData/smsManagementSubscriptionData",
            "operation": executionRequest.properties.operation4
        }
