    ...
    if(item.match(/^MMS$/)){
        ...
        message.modifications.push(

            {
                ...
                "operation": executionRequest.properties.operation1,
                "valueObject": {
                    "flagAPNBlockedOverS6A": executionRequest.properties.flagAPNBlockedOverS6A1,
                    "flagAPNBlockedOverSWx": executionRequest.properties.flagAPNBlockedOverSWx1
                }
            },
			{
                "path": "udm5gData/servingPlmnId/provisionedData/smfSelectionSubscriptionData/sNssaiInfo/dnnInfo[@dnnId='"+executionRequest.properties.dnn7+"']/dnnBarred",
