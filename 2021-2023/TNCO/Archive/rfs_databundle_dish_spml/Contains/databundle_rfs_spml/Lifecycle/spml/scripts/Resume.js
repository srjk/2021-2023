...
array.forEach(function (item, index) {
    ...
    if(item.match(/^DATA$/)){
      ...
      message.modifications.push({
         ...
         "valueObject":{
            "odbgprs": executionRequest.properties.hlr_odbgprs1
         }
      },
      {
         ...
         "valueObject":{
            "flagAPNBlockedOverS6A": executionRequest.properties.hlr1_flagAPNBlockedOverS6A,
            "flagAPNBlockedOverSWx": executionRequest.properties.hlr1_flagAPNBlockedOverSWx
         }
      },
      {
         ...
         "operation": executionRequest.properties.operation2,
         "valueObject":{
            "defaultPdnContextId": executionRequest.properties.hlr1_defaultPdnContextId
         }
      },
	  {
         "path":"udm5gData/servingPlmnId/provisionedData/smfSelectionSubscriptionData/sNssaiInfo/dnnInfo[@dnnId='"+executionRequest.properties.dnn4+"']/dnnBarred",
   ...
   if(item.match(/^HOTSPOT$/)){
      ...
      message.modifications.push( {
	   ...
	   {
         "path":"udm5gData/servingPlmnId/provisionedData/smfSelectionSubscriptionData/sNssaiInfo/dnnInfo[@dnnId='"+executionRequest.properties.dnn6+"']/dnnBarred",
         "path":"udm5gData/servingPlmnId/provisionedData/smfSelectionSubscriptionData/sNssaiInfo/dnnInfo[@dnnId='"+executionRequest.properties.dnn6+"']/dnnBarred",
         "operation": executionRequest.properties.operation4,
      })};   
