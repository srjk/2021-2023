...
defaultData={'RoamingType': '*', 'SliceName': sliceName, 'RowNumber': max(default_rownumber)+1, 'SessionRule': sys.argv[5], 'PlanType': sys.argv[9],'RatePlan': sys.argv[4], 'DNN': sys.argv[3], 'PCCRuleName': [sys.argv[6]],"ThrottledBW": sys.argv[7]}
