...
​
	curl -k --location --request POST 'http://{{ ansible_env.NOI_HOST }}/jaxws/impact/ImpactWebServiceListenerDLIfc' \
--header 'Content-Type: text/xml' -u {{ ansible_env.NOI_USER }}:{{ ansible_env.NOI_PASS }} \
